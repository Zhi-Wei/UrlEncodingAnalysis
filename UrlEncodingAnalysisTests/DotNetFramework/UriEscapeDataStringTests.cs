...
{
    /// <summary>
    /// Uri 類別 EscapeDataString 方法的測試類別。
    /// </summary>
    [TestClass]
    public class UriEscapeDataStringTests
    {
        #region -- RFC 3986 保留字 --

        [TestMethod]
        [TestCategory(nameof(Uri))]
        [TestProperty(nameof(Uri), nameof(Uri.EscapeDataString))]
        public void 當輸入為RFC3986保留字的冒號時_必須編碼為百分號3A()
        {
            ...
            // Act
            var actual = Uri.EscapeDataString(input);
        ...
        public void 當輸入為長度65520的字串時_必須無拋出例外()
        {
            ...
            // Act
            Action act = () => Uri.EscapeDataString(input);
        ...
        public void 當輸入為任何的字元字串時_必須無拋出例外()
        {
            ...
            // Act
            Action act = () => allChars.ForEach(c => Uri.EscapeDataString(c.ToString()));
