...
namespace UrlEncodingAnalysisTests.FlurlLibrary
{
    ...
    public class UrlEncodeTests
    {
        ...
        [TestProperty(nameof(Url), nameof(Url.Encode))]
        ...
        public void 當輸入為任何的字元字串時_必須無拋出例外()
        {
            ...
            // Act
            Action act = () => allChars.ForEach(c => Url.Encode(c.ToString()));
